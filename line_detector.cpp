...
int LineDetector::moving_average_intercepts_(std::queue<int> &past_intercepts,
                                             int new_intercept,
                                             int &current_sum) {
...
float LineDetector::moving_average_slopes_(std::queue<float> &past_slopes,
                                           float new_slope,
                                           float &current_sum) {
...
std::tuple<cv::Vec4i, cv::Vec4i> LineDetector::find_lines(
    const cv::Mat &frame) {
